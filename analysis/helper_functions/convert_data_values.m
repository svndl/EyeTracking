...
for x = 1:length(res.trials.trialnum)
    ...
    res.trials.LExAng{x} = convert_screen_to_deg(res.trials.LExCm{x},res.el,res.ipd);
    res.trials.LEyAng{x} = convert_screen_to_deg(res.trials.LEyCm{x},res.el,res.ipd);
    res.trials.RExAng{x} = convert_screen_to_deg(res.trials.RExCm{x},res.el,-res.ipd);
    res.trials.REyAng{x} = convert_screen_to_deg(res.trials.REyCm{x},res.el,-res.ipd);
