...
dat.rampSpeedDegSec = 0.5;      % ramp speed in degrees per second
...
% conditions
dat.conditions      = {'MixedIncons'};      % dot conditions, IOVD, CDOT, etc
dat.cond_repeats    = 5;      % number of repeats per condition
dat.dynamics        = {'ramp'};      % steps, ramps, etc
dat.directions      = {'left','right','towards','away'};      % initial motion direction
