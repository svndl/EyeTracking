function [dotFrames, dotColor, dotSize] = antiCorrDotFrames(dotParams, videoMode)
    ...
    if (~strcmp(dotParams.cues, 'SingleDot'))
        ...
        [dotFrames{1}, dotColor{1}, dotSize{1}] = getDots(dotParams, videoMode.lwhite, videoMode.rblack);
        [dotFrames{2}, dotColor{2}, dotSize{2}] = getDots(dotParams, videoMode.lblack, videoMode.rwhite);
        %
    else
