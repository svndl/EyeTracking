...
% length of diagonal lines
	...
	if flipIt	
	% horizontal
		Screen('DrawLine', w, scr.REwhite, scr.x_center_pix_right - (scr.signRight*scr.fixationRadiusXPix), ...
		...
		Screen('DrawLine', w, scr.LEwhite, scr.x_center_pix_left + (scr.fixationDotRadiusPix + line_width), ...
