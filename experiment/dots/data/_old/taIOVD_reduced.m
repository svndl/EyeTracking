...
dat.nonius          = 1;      % nonius on during trial (1) or not(0)

% dot field properties
dat.stimRadDeg      = 18;      % stimulus field radius
dat.dispArcmin      = 60;      % disparity magnitude
dat.rampSpeedDegSec = 0.8;      % ramp speed in degrees per second
...
dat.cond_repeats    = 15;      % number of repeats per condition
dat.dynamics        = {'ramp'};      % steps, ramps, etc
dat.directions      = {'towards'};      % initial motion direction
