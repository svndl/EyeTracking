function run_ET_Experiments(varargin)
    ...
    %addpath([ pwd '/helper_functions:' pwd '/options:' pwd '/settings' ]);   % add path to helper functions
    [dat, scr]  = gui_settings(varargin, etpath);           % put argument contents into data fields, deal with defaults
